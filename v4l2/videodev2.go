...
var (
	PixFmt_Rgb332         PixFmt = Fourcc('R', 'G', 'B', '1')
	PixFmt_Rgb444         PixFmt = Fourcc('R', '4', '4', '4')
	PixFmt_Argb444        PixFmt = Fourcc('A', 'R', '1', '2')
	PixFmt_Xrgb444        PixFmt = Fourcc('X', 'R', '1', '2')
	PixFmt_Rgba444        PixFmt = Fourcc('R', 'A', '1', '2')
	PixFmt_Rgbx444        PixFmt = Fourcc('R', 'X', '1', '2')
	PixFmt_Abgr444        PixFmt = Fourcc('A', 'B', '1', '2')
	PixFmt_Xbgr444        PixFmt = Fourcc('X', 'B', '1', '2')
	PixFmt_Bgra444        PixFmt = Fourcc('G', 'A', '1', '2')
	PixFmt_Bgrx444        PixFmt = Fourcc('B', 'X', '1', '2')
	PixFmt_Rgb555         PixFmt = Fourcc('R', 'G', 'B', 'O')
	PixFmt_Argb555        PixFmt = Fourcc('A', 'R', '1', '5')
	PixFmt_Xrgb555        PixFmt = Fourcc('X', 'R', '1', '5')
	PixFmt_Rgba555        PixFmt = Fourcc('R', 'A', '1', '5')
	PixFmt_Rgbx555        PixFmt = Fourcc('R', 'X', '1', '5')
	PixFmt_Abgr555        PixFmt = Fourcc('A', 'B', '1', '5')
	PixFmt_Xbgr555        PixFmt = Fourcc('X', 'B', '1', '5')
	PixFmt_Bgra555        PixFmt = Fourcc('B', 'A', '1', '5')
	PixFmt_Bgrx555        PixFmt = Fourcc('B', 'X', '1', '5')
	PixFmt_Rgb565         PixFmt = Fourcc('R', 'G', 'B', 'P')
	PixFmt_Rgb555X        PixFmt = Fourcc('R', 'G', 'B', 'Q')
	PixFmt_Argb555X       PixFmt = FourccBe('A', 'R', '1', '5')
	PixFmt_Xrgb555X       PixFmt = FourccBe('X', 'R', '1', '5')
	PixFmt_Rgb565X        PixFmt = Fourcc('R', 'G', 'B', 'R')
	PixFmt_Bgr666         PixFmt = Fourcc('B', 'G', 'R', 'H')
	PixFmt_Bgr24          PixFmt = Fourcc('B', 'G', 'R', '3')
	PixFmt_Rgb24          PixFmt = Fourcc('R', 'G', 'B', '3')
	PixFmt_Bgr32          PixFmt = Fourcc('B', 'G', 'R', '4')
	PixFmt_Abgr32         PixFmt = Fourcc('A', 'R', '2', '4')
	PixFmt_Xbgr32         PixFmt = Fourcc('X', 'R', '2', '4')
	PixFmt_Bgra32         PixFmt = Fourcc('R', 'A', '2', '4')
	PixFmt_Bgrx32         PixFmt = Fourcc('R', 'X', '2', '4')
	PixFmt_Rgb32          PixFmt = Fourcc('R', 'G', 'B', '4')
	PixFmt_Rgba32         PixFmt = Fourcc('A', 'B', '2', '4')
	PixFmt_Rgbx32         PixFmt = Fourcc('X', 'B', '2', '4')
	PixFmt_Argb32         PixFmt = Fourcc('B', 'A', '2', '4')
	PixFmt_Xrgb32         PixFmt = Fourcc('B', 'X', '2', '4')
	PixFmt_Grey           PixFmt = Fourcc('G', 'R', 'E', 'Y')
	PixFmt_Y4             PixFmt = Fourcc('Y', '0', '4', ' ')
	PixFmt_Y6             PixFmt = Fourcc('Y', '0', '6', ' ')
	PixFmt_Y10            PixFmt = Fourcc('Y', '1', '0', ' ')
	PixFmt_Y12            PixFmt = Fourcc('Y', '1', '2', ' ')
	PixFmt_Y16            PixFmt = Fourcc('Y', '1', '6', ' ')
	PixFmt_Y16_Be         PixFmt = FourccBe('Y', '1', '6', ' ')
	PixFmt_Y10Bpack       PixFmt = Fourcc('Y', '1', '0', 'B')
	PixFmt_Y10P           PixFmt = Fourcc('Y', '1', '0', 'P')
	PixFmt_Pal8           PixFmt = Fourcc('P', 'A', 'L', '8')
	PixFmt_Uv8            PixFmt = Fourcc('U', 'V', '8', ' ')
	PixFmt_Yuyv           PixFmt = Fourcc('Y', 'U', 'Y', 'V')
	PixFmt_Yyuv           PixFmt = Fourcc('Y', 'Y', 'U', 'V')
	PixFmt_Yvyu           PixFmt = Fourcc('Y', 'V', 'Y', 'U')
	PixFmt_Uyvy           PixFmt = Fourcc('U', 'Y', 'V', 'Y')
	PixFmt_Vyuy           PixFmt = Fourcc('V', 'Y', 'U', 'Y')
	PixFmt_Y41P           PixFmt = Fourcc('Y', '4', '1', 'P')
	PixFmt_Yuv444         PixFmt = Fourcc('Y', '4', '4', '4')
	PixFmt_Yuv555         PixFmt = Fourcc('Y', 'U', 'V', 'O')
	PixFmt_Yuv565         PixFmt = Fourcc('Y', 'U', 'V', 'P')
	PixFmt_Yuv32          PixFmt = Fourcc('Y', 'U', 'V', '4')
	PixFmt_Ayuv32         PixFmt = Fourcc('A', 'Y', 'U', 'V')
	PixFmt_Xyuv32         PixFmt = Fourcc('X', 'Y', 'U', 'V')
	PixFmt_Vuya32         PixFmt = Fourcc('V', 'U', 'Y', 'A')
	PixFmt_Vuyx32         PixFmt = Fourcc('V', 'U', 'Y', 'X')
	PixFmt_Hi240          PixFmt = Fourcc('H', 'I', '2', '4')
	PixFmt_Hm12           PixFmt = Fourcc('H', 'M', '1', '2')
	PixFmt_M420           PixFmt = Fourcc('M', '4', '2', '0')
	PixFmt_Nv12           PixFmt = Fourcc('N', 'V', '1', '2')
	PixFmt_Nv21           PixFmt = Fourcc('N', 'V', '2', '1')
	PixFmt_Nv16           PixFmt = Fourcc('N', 'V', '1', '6')
	PixFmt_Nv61           PixFmt = Fourcc('N', 'V', '6', '1')
	PixFmt_Nv24           PixFmt = Fourcc('N', 'V', '2', '4')
	PixFmt_Nv42           PixFmt = Fourcc('N', 'V', '4', '2')
	PixFmt_Nv12M          PixFmt = Fourcc('N', 'M', '1', '2')
	PixFmt_Nv21M          PixFmt = Fourcc('N', 'M', '2', '1')
	PixFmt_Nv16M          PixFmt = Fourcc('N', 'M', '1', '6')
	PixFmt_Nv61M          PixFmt = Fourcc('N', 'M', '6', '1')
	PixFmt_Nv12Mt         PixFmt = Fourcc('T', 'M', '1', '2')
	PixFmt_Nv12Mt16X16    PixFmt = Fourcc('V', 'M', '1', '2')
	PixFmt_Yuv410         PixFmt = Fourcc('Y', 'U', 'V', '9')
	PixFmt_Yvu410         PixFmt = Fourcc('Y', 'V', 'U', '9')
	PixFmt_Yuv411P        PixFmt = Fourcc('4', '1', '1', 'P')
	PixFmt_Yuv420         PixFmt = Fourcc('Y', 'U', '1', '2')
	PixFmt_Yvu420         PixFmt = Fourcc('Y', 'V', '1', '2')
	PixFmt_Yuv422P        PixFmt = Fourcc('4', '2', '2', 'P')
	PixFmt_Yuv420M        PixFmt = Fourcc('Y', 'M', '1', '2')
	PixFmt_Yvu420M        PixFmt = Fourcc('Y', 'M', '2', '1')
	PixFmt_Yuv422M        PixFmt = Fourcc('Y', 'M', '1', '6')
	PixFmt_Yvu422M        PixFmt = Fourcc('Y', 'M', '6', '1')
	PixFmt_Yuv444M        PixFmt = Fourcc('Y', 'M', '2', '4')
	PixFmt_Yvu444M        PixFmt = Fourcc('Y', 'M', '4', '2')
	PixFmt_Sbggr8         PixFmt = Fourcc('B', 'A', '8', '1')
	PixFmt_Sgbrg8         PixFmt = Fourcc('G', 'B', 'R', 'G')
	PixFmt_Sgrbg8         PixFmt = Fourcc('G', 'R', 'B', 'G')
	PixFmt_Srggb8         PixFmt = Fourcc('R', 'G', 'G', 'B')
	PixFmt_Sbggr10        PixFmt = Fourcc('B', 'G', '1', '0')
	PixFmt_Sgbrg10        PixFmt = Fourcc('G', 'B', '1', '0')
	PixFmt_Sgrbg10        PixFmt = Fourcc('B', 'A', '1', '0')
	PixFmt_Srggb10        PixFmt = Fourcc('R', 'G', '1', '0')
	PixFmt_Sbggr10P       PixFmt = Fourcc('p', 'B', 'A', 'A')
	PixFmt_Sgbrg10P       PixFmt = Fourcc('p', 'G', 'A', 'A')
	PixFmt_Sgrbg10P       PixFmt = Fourcc('p', 'g', 'A', 'A')
	PixFmt_Srggb10P       PixFmt = Fourcc('p', 'R', 'A', 'A')
	PixFmt_Sbggr10Alaw8   PixFmt = Fourcc('a', 'B', 'A', '8')
	PixFmt_Sgbrg10Alaw8   PixFmt = Fourcc('a', 'G', 'A', '8')
	PixFmt_Sgrbg10Alaw8   PixFmt = Fourcc('a', 'g', 'A', '8')
	PixFmt_Srggb10Alaw8   PixFmt = Fourcc('a', 'R', 'A', '8')
	PixFmt_Sbggr10Dpcm8   PixFmt = Fourcc('b', 'B', 'A', '8')
	PixFmt_Sgbrg10Dpcm8   PixFmt = Fourcc('b', 'G', 'A', '8')
	PixFmt_Sgrbg10Dpcm8   PixFmt = Fourcc('B', 'D', '1', '0')
	PixFmt_Srggb10Dpcm8   PixFmt = Fourcc('b', 'R', 'A', '8')
	PixFmt_Sbggr12        PixFmt = Fourcc('B', 'G', '1', '2')
	PixFmt_Sgbrg12        PixFmt = Fourcc('G', 'B', '1', '2')
	PixFmt_Sgrbg12        PixFmt = Fourcc('B', 'A', '1', '2')
	PixFmt_Srggb12        PixFmt = Fourcc('R', 'G', '1', '2')
	PixFmt_Sbggr12P       PixFmt = Fourcc('p', 'B', 'C', 'C')
	PixFmt_Sgbrg12P       PixFmt = Fourcc('p', 'G', 'C', 'C')
	PixFmt_Sgrbg12P       PixFmt = Fourcc('p', 'g', 'C', 'C')
	PixFmt_Srggb12P       PixFmt = Fourcc('p', 'R', 'C', 'C')
	PixFmt_Sbggr14P       PixFmt = Fourcc('p', 'B', 'E', 'E')
	PixFmt_Sgbrg14P       PixFmt = Fourcc('p', 'G', 'E', 'E')
	PixFmt_Sgrbg14P       PixFmt = Fourcc('p', 'g', 'E', 'E')
	PixFmt_Srggb14P       PixFmt = Fourcc('p', 'R', 'E', 'E')
	PixFmt_Sbggr16        PixFmt = Fourcc('B', 'Y', 'R', '2')
	PixFmt_Sgbrg16        PixFmt = Fourcc('G', 'B', '1', '6')
	PixFmt_Sgrbg16        PixFmt = Fourcc('G', 'R', '1', '6')
	PixFmt_Srggb16        PixFmt = Fourcc('R', 'G', '1', '6')
	PixFmt_Hsv24          PixFmt = Fourcc('H', 'S', 'V', '3')
	PixFmt_Hsv32          PixFmt = Fourcc('H', 'S', 'V', '4')
	PixFmt_Mjpeg          PixFmt = Fourcc('M', 'J', 'P', 'G')
	PixFmt_Jpeg           PixFmt = Fourcc('J', 'P', 'E', 'G')
	PixFmt_Dv             PixFmt = Fourcc('d', 'v', 's', 'd')
	PixFmt_Mpeg           PixFmt = Fourcc('M', 'P', 'E', 'G')
	PixFmt_H264           PixFmt = Fourcc('H', '2', '6', '4')
	PixFmt_H264_NoSc      PixFmt = Fourcc('A', 'V', 'C', '1')
	PixFmt_H264_Mvc       PixFmt = Fourcc('M', '2', '6', '4')
	PixFmt_H263           PixFmt = Fourcc('H', '2', '6', '3')
	PixFmt_Mpeg1          PixFmt = Fourcc('M', 'P', 'G', '1')
	PixFmt_Mpeg2          PixFmt = Fourcc('M', 'P', 'G', '2')
	PixFmt_Mpeg2_Slice    PixFmt = Fourcc('M', 'G', '2', 'S')
	PixFmt_Mpeg4          PixFmt = Fourcc('M', 'P', 'G', '4')
	PixFmt_Xvid           PixFmt = Fourcc('X', 'V', 'I', 'D')
	PixFmt_Vc1_AnnexG     PixFmt = Fourcc('V', 'C', '1', 'G')
	PixFmt_Vc1_AnnexL     PixFmt = Fourcc('V', 'C', '1', 'L')
	PixFmt_Vp8            PixFmt = Fourcc('V', 'P', '8', '0')
	PixFmt_Vp9            PixFmt = Fourcc('V', 'P', '9', '0')
	PixFmt_Hevc           PixFmt = Fourcc('H', 'E', 'V', 'C')
	PixFmt_Fwht           PixFmt = Fourcc('F', 'W', 'H', 'T')
	PixFmt_FwhtStateless  PixFmt = Fourcc('S', 'F', 'W', 'H')
	PixFmt_Cpia1          PixFmt = Fourcc('C', 'P', 'I', 'A')
	PixFmt_Wnva           PixFmt = Fourcc('W', 'N', 'V', 'A')
	PixFmt_Sn9C10X        PixFmt = Fourcc('S', '9', '1', '0')
	PixFmt_Sn9C20Xi420    PixFmt = Fourcc('S', '9', '2', '0')
	PixFmt_Pwc1           PixFmt = Fourcc('P', 'W', 'C', '1')
	PixFmt_Pwc2           PixFmt = Fourcc('P', 'W', 'C', '2')
	PixFmt_Et61X251       PixFmt = Fourcc('E', '6', '2', '5')
	PixFmt_Spca501        PixFmt = Fourcc('S', '5', '0', '1')
	PixFmt_Spca505        PixFmt = Fourcc('S', '5', '0', '5')
	PixFmt_Spca508        PixFmt = Fourcc('S', '5', '0', '8')
	PixFmt_Spca561        PixFmt = Fourcc('S', '5', '6', '1')
	PixFmt_Pac207         PixFmt = Fourcc('P', '2', '0', '7')
	PixFmt_Mr97310A       PixFmt = Fourcc('M', '3', '1', '0')
	PixFmt_Jl2005Bcd      PixFmt = Fourcc('J', 'L', '2', '0')
	PixFmt_Sn9C2028       PixFmt = Fourcc('S', 'O', 'N', 'X')
	PixFmt_Sq905C         PixFmt = Fourcc('9', '0', '5', 'C')
	PixFmt_Pjpg           PixFmt = Fourcc('P', 'J', 'P', 'G')
	PixFmt_Ov511          PixFmt = Fourcc('O', '5', '1', '1')
	PixFmt_Ov518          PixFmt = Fourcc('O', '5', '1', '8')
	PixFmt_Stv0680        PixFmt = Fourcc('S', '6', '8', '0')
	PixFmt_Tm6000         PixFmt = Fourcc('T', 'M', '6', '0')
	PixFmt_CitYyvyuy      PixFmt = Fourcc('C', 'I', 'T', 'V')
	PixFmt_Konica420      PixFmt = Fourcc('K', 'O', 'N', 'I')
	PixFmt_Jpgl           PixFmt = Fourcc('J', 'P', 'G', 'L')
	PixFmt_Se401          PixFmt = Fourcc('S', '4', '0', '1')
	PixFmt_S5CuyvyJpg     PixFmt = Fourcc('S', '5', 'C', 'I')
	PixFmtY8I             PixFmt = Fourcc('Y', '8', 'I', ' ')
	PixFmt_Y12I           PixFmt = Fourcc('Y', '1', '2', 'I')
	PixFmt_Z16            PixFmt = Fourcc('Z', '1', '6', ' ')
	PixFmt_Mt21C          PixFmt = Fourcc('M', 'T', '2', '1')
	PixFmt_Inzi           PixFmt = Fourcc('I', 'N', 'Z', 'I')
	PixFmt_SunxiTiledNv12 PixFmt = Fourcc('S', 'T', '1', '2')
	PixFmt_Cnf4           PixFmt = Fourcc('C', 'N', 'F', '4')
	PixFmt_Ipu3_Sbggr10   PixFmt = Fourcc('i', 'p', '3', 'b')
	PixFmt_Ipu3_Sgbrg10   PixFmt = Fourcc('i', 'p', '3', 'g')
	PixFmt_Ipu3_Sgrbg10   PixFmt = Fourcc('i', 'p', '3', 'G')
	PixFmt_Ipu3_Srggb10   PixFmt = Fourcc('i', 'p', '3', 'r')
	SdrFmt_Cu8            PixFmt = Fourcc('C', 'U', '0', '8')
	SdrFmt_Cu16Le         PixFmt = Fourcc('C', 'U', '1', '6')
	SdrFmt_Cs8            PixFmt = Fourcc('C', 'S', '0', '8')
	SdrFmt_Cs14Le         PixFmt = Fourcc('C', 'S', '1', '4')
	SdrFmt_Ru12Le         PixFmt = Fourcc('R', 'U', '1', '2')
	SdrFmt_Pcu16Be        PixFmt = Fourcc('P', 'C', '1', '6')
	SdrFmt_Pcu18Be        PixFmt = Fourcc('P', 'C', '1', '8')
	SdrFmt_Pcu20Be        PixFmt = Fourcc('P', 'C', '2', '0')
	TchFmt_DeltaTd16      PixFmt = Fourcc('T', 'D', '1', '6')
	TchFmt_DeltaTd08      PixFmt = Fourcc('T', 'D', '0', '8')
	TchFmt_Tu16           PixFmt = Fourcc('T', 'U', '1', '6')
	TchFmt_Tu08           PixFmt = Fourcc('T', 'U', '0', '8')
	MetaFmt_Vsp1Hgo       PixFmt = Fourcc('V', 'S', 'P', 'H')
	MetaFmt_Vsp1Hgt       PixFmt = Fourcc('V', 'S', 'P', 'T')
	MetaFmt_Uvc           PixFmt = Fourcc('U', 'V', 'C', 'H')
	MetaFmt_D4Xx          PixFmt = Fourcc('D', '4', 'X', 'X')
	PixFmt_PrivMagic      PixFmt = 0xfeedcafe
)
...
var (
	...
	Vidioc_GFmt      Vidioc = _IOWR('V', 4, unsafe.Sizeof(Format{}))
	Vidioc_SFmt      Vidioc = _IOWR('V', 5, unsafe.Sizeof(Format{}))
	Vidioc_Reqbufs   Vidioc = _IOWR('V', 8, unsafe.Sizeof(RequestBuffers{}))
	Vidioc_Querybuf  Vidioc = _IOWR('V', 9, unsafe.Sizeof(Buffer{}))
	Vidioc_GFbuf     Vidioc = _IOR('V', 10, unsafe.Sizeof(FrameBuffer{}))
	Vidioc_SFbuf     Vidioc = _IOW('V', 11, unsafe.Sizeof(FrameBuffer{}))
	Vidioc_Overlay   Vidioc = _IOW('V', 14, unsafe.Sizeof(int(0)))
	Vidioc_Qbuf      Vidioc = _IOWR('V', 15, unsafe.Sizeof(Buffer{}))
	Vidioc_Expbuf    Vidioc = _IOWR('V', 16, unsafe.Sizeof(ExportBuffer{}))
	Vidioc_Dqbuf     Vidioc = _IOWR('V', 17, unsafe.Sizeof(Buffer{}))
	Vidioc_StreamOn  Vidioc = _IOW('V', 18, unsafe.Sizeof(int(0)))
	Vidioc_StreamOff Vidioc = _IOW('V', 19, unsafe.Sizeof(int(0)))
	Vidioc_GParm     Vidioc = _IOWR('V', 21, unsafe.Sizeof(StreamParm{}))
	Vidioc_SParm     Vidioc = _IOWR('V', 22, unsafe.Sizeof(StreamParm{}))
	Vidioc_GStd      Vidioc = _IOR('V', 23, unsafe.Sizeof(StdId(0)))
	Vidioc_SStd      Vidioc = _IOW('V', 24, unsafe.Sizeof(StdId(0)))
	Vidioc_EnumStd   Vidioc = _IOWR('V', 25, unsafe.Sizeof(Standard{}))
	Vidioc_EnumInput Vidioc = _IOWR('V', 26, unsafe.Sizeof(Input{}))
	Vidioc_GCtrl     Vidioc = _IOWR('V', 27, unsafe.Sizeof(Control{}))
	Vidioc_SCtrl     Vidioc = _IOWR('V', 28, unsafe.Sizeof(Control{}))
	Vidioc_GTuner    Vidioc = _IOWR('V', 29, unsafe.Sizeof(Tuner{}))
	Vidioc_STuner    Vidioc = _IOW('V', 30, unsafe.Sizeof(Tuner{}))
	Vidioc_GAudio    Vidioc = _IOR('V', 33, unsafe.Sizeof(Audio{}))
	Vidioc_SAudio    Vidioc = _IOW('V', 34, unsafe.Sizeof(Audio{}))
	Vidioc_Queryctrl Vidioc = _IOWR('V', 36, unsafe.Sizeof(QueryCtrl{}))
	Vidioc_Querymenu Vidioc = _IOWR('V', 37, unsafe.Sizeof(QueryMenu{}))
	Vidioc_GInput    Vidioc = _IOR('V', 38, unsafe.Sizeof(int(0)))
	Vidioc_SInput    Vidioc = _IOWR('V', 39, unsafe.Sizeof(int(0)))
	// TODO: get struct v4l2_edid from v4l2-common.h
	//Vidioc_GEdid              Vidioc = _IOWR('V', 40, unsafe.Sizeof(edid{}))
	//Vidioc_SEdid              Vidioc = _IOWR('V', 41, unsafe.Sizeof(edid{}))
	Vidioc_GOutput            Vidioc = _IOR('V', 46, unsafe.Sizeof(int(0)))
	Vidioc_SOutput            Vidioc = _IOWR('V', 47, unsafe.Sizeof(int(0)))
	Vidioc_EnumOutput         Vidioc = _IOWR('V', 48, unsafe.Sizeof(Output{}))
	Vidioc_GAudOut            Vidioc = _IOR('V', 49, unsafe.Sizeof(AudioOut{}))
	Vidioc_SAudOut            Vidioc = _IOW('V', 50, unsafe.Sizeof(AudioOut{}))
	Vidioc_GModulator         Vidioc = _IOWR('V', 54, unsafe.Sizeof(Modulator{}))
	Vidioc_SModulator         Vidioc = _IOW('V', 55, unsafe.Sizeof(Modulator{}))
	Vidioc_GFrequency         Vidioc = _IOWR('V', 56, unsafe.Sizeof(Frequency{}))
	Vidioc_SFrequency         Vidioc = _IOW('V', 57, unsafe.Sizeof(Frequency{}))
	Vidioc_CropCap            Vidioc = _IOWR('V', 58, unsafe.Sizeof(CropCap{}))
	Vidioc_GCrop              Vidioc = _IOWR('V', 59, unsafe.Sizeof(Crop{}))
	Vidioc_SCrop              Vidioc = _IOW('V', 60, unsafe.Sizeof(Crop{}))
	Vidioc_GJpegComp          Vidioc = _IOR('V', 61, unsafe.Sizeof(JpegCompression{}))
	Vidioc_SJpegComp          Vidioc = _IOW('V', 62, unsafe.Sizeof(JpegCompression{}))
	Vidioc_QueryStd           Vidioc = _IOR('V', 63, unsafe.Sizeof(StdId(0)))
	Vidioc_TryFmt             Vidioc = _IOWR('V', 64, unsafe.Sizeof(Format{}))
	Vidioc_EnumAudio          Vidioc = _IOWR('V', 65, unsafe.Sizeof(Audio{}))
	Vidioc_EnumAudOut         Vidioc = _IOWR('V', 66, unsafe.Sizeof(AudioOut{}))
	Vidioc_GPriority          Vidioc = _IOR('V', 67, unsafe.Sizeof(Priority(0)))
	Vidioc_SPriority          Vidioc = _IOW('V', 68, unsafe.Sizeof(Priority(0)))
	Vidioc_GSlicedVbiCap      Vidioc = _IOWR('V', 69, unsafe.Sizeof(SlicedVbiCap{}))
	Vidioc_LogStatus          Vidioc = _IO('V', 70)
	Vidioc_GExtCtrls          Vidioc = _IOWR('V', 71, unsafe.Sizeof(ExtControls{}))
	Vidioc_SExtCtrls          Vidioc = _IOWR('V', 72, unsafe.Sizeof(ExtControls{}))
	Vidioc_TryExtCtrls        Vidioc = _IOWR('V', 73, unsafe.Sizeof(ExtControls{}))
	Vidioc_EnumFrameSizes     Vidioc = _IOWR('V', 74, unsafe.Sizeof(FrmSizeEnum{}))
	Vidioc_EnumFrameIntervals Vidioc = _IOWR('V', 75, unsafe.Sizeof(FrmIvalEnum{}))
	Vidioc_GEncIndex          Vidioc = _IOR('V', 76, unsafe.Sizeof(EncIdx{}))
	Vidioc_EncoderCmd         Vidioc = _IOWR('V', 77, unsafe.Sizeof(EncoderCmd{}))
	Vidioc_TryEncoderCmd      Vidioc = _IOWR('V', 78, unsafe.Sizeof(EncoderCmd{}))
)
